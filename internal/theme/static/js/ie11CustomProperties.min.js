...
! function() {
  ...
  if (e.style.setProperty("--x", "y"), "y" !== e.style.getPropertyValue("--x") && e.msMatchesSelector) {
    ...
    var v = 0,
      h = new MutationObserver(function(e) {
        if (!l)
          for (var t, r = 0; t = e[r++];) "iecp-needed" !== t.attributeName && J(t.target)
      });
    setTimeout(function() {
      h.observe(document, {
        attributes: !0,
  ...
  function M(e, o) {
    for (var i, s = {
      ...
      }, c = w(n, s.selector), l = 0; i = c[l++];) s.elements.set(i, !0), s.callback.call(i, i);
      ...
      for (; r = e[l++];) {
        if ("(" === r && (++o, null === i && e[l - 4] + e[l - 3] + e[l - 2] === "var" && (i = o, c += e.substring(s, l - 4), s = l), e[l - 5] + e[l - 4] + e[l - 3] + e[l - 2] === "calc" && (n = o)), ")" === r && i === o) {
          let r, o = e.substring(s, l - 1).trim(),
            a = o.indexOf(","); - 1 !== a && (r = o.slice(a + 1), o = o.slice(0, a)), c += t(o, r, n), s = l, i = null
        }
        ")" === r && n === --o && (n = null)
      }
